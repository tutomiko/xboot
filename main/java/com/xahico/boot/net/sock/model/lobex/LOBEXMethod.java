...
**/
final class LOBEXMethod <REQ extends LOBEXRequest, RSP extends LOBEXResponse> {
	...
	LOBEXMethod (final ReflectionMethod methodHandle, final String control, final Class<REQ> requestClass, final Class<RSP> responseClass){
		super();
