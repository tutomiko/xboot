...
**/
public class GWXListBackedReadOnlyNodeCollection <T extends GWXNode> extends GWXReadOnlyNodeCollection<T> {
	...
	public GWXListBackedReadOnlyNodeCollection (final GWXNode owner, final List<T> nodes){
		super(owner);
